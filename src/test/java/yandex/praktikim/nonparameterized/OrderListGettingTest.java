...
public class OrderListGettingTest extends BaseTestClass {
    ...
    public void dataMatching(Response response) {
        ...
        //не знал, нужен ли тут конкретный ассерт, без него тоже будет падать и ничего не блочить при провале теста
        //так же мог использовать try-catch для обработки ошибки мэтчинга и заюзать два assertTrue - в блоке try, всегда
        //равный true, и в блоке catch, всегда false
    }
}
